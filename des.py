...
# DES Algorithm
# источник теоретического материала: http://page.math.tu-berlin.de/~kant/teaching/hess/krypto-ws2006/des.htm
...
def main(mess, mod):
    ...
    if mod == 1:
        ...
        print("Encrypted message = ",''.join(encrypted_list))
        ...
        if (len(mess) == 16):
            ...
            print("Wrong sentence to decrypt!")
...
if __name__ == '__main__':
    ...
    while mod != int(5):
        try:
            mod = int(input('Choose mod (1 - encrypt, 2 - decrypt, 5 - exit: '))
        except:
            print("Wrong method")
            mod = int(0)
        else:
